package com.spantech.recursive;
...
public class RecursiveFunctionDemo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("GDC of 12 16 24 = " + find(RecursiveFunctionDemo::gcd, 12, 16, 24));
        System.out.println("LCM of 12 16 24 = " + find(RecursiveFunctionDemo::lcm, 12, 16, 24));
    }
